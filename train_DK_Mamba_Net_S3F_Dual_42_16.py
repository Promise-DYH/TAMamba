...
if DATASET == 'Vaihingen':
    from utils_Mamba_new_Boundry_best_16 import *
    ...
    for e in range(1, epochs + 1):
        ...
        if e % save_epoch == 0:
            ...
            if current_MIoU > MIoU_best:
                ...
                save_path = f'/home/duyihan/pycharm_project/SSRS-main/SAM_RS_L40/TRY/resultv_DK_Mamba_Net_S3F_Dual/42_16/0k/1_75_8_5/{MODEL}_epoch{e}_MIoU{MIoU_best:.4f}.pth'
